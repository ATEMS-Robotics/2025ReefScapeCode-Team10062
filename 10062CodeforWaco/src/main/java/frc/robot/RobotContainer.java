...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // Coral Arm
        driverController.povUp().onTrue(coralEater.moveToPosition(Position_one));
        driverController.povUp().onTrue(Commands.print("Whats Up dawg"));
        driverController.povDown().onTrue(coralEater.moveToPosition(Position_two));
        driverController.povDown().onTrue(Commands.print("Whats downsysndrome dahwg"));
        driverController.rightTrigger().onTrue(coralEater.moveToPosition(Position_three));
        driverController.rightTrigger().onTrue(Commands.print("Sigma Trigger got rizzed up"));
